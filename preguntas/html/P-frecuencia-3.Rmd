...
incorrectas <- list(c(correctas[3], correctas[4], ifelse(correctas[6] != correctas[1], correctas[6], as.character(freq$cum[i] + 1))),
                    ...
                    c(correctas[1], correctas[4], ifelse(correctas[3] != correctas[9], correctas[3], as.character(freq$freqrel[i] + 0.1))),
...
Question
========
**P-frecuencia-3**. Se realizó experimento de memoria. Se les enseñó 30 palabras a cada uno de los participantes y se registró el número de palabras recordadas. Dada la siguiente matriz de datos:  
