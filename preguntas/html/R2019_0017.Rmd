...
x1 <- rmultinom(1, nx1, c(0.2, 0.2, 0.6))
x2 <- rmultinom(1, nx2, c(0.6, 0.3, 0.1))
...
correcta <- c("La tenencia de conexión a Internet en el hogar se asocia con un peor rendimiento en matemáticas")
...
Question
========
**R2019_0017**. Se realizó un estudio en el que se desea saber si la tenencia de conexión a internet en el hogar, influye en el rendimiento escolar en matemáticas en alumnos de la escuela primaria. Se evaluó una muestra de 1000 alumnos. Se obtuvieron los siguientes resultados:
