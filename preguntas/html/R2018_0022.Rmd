...
Question
========
**R2018_0022**. Al `r paste(x1, "%")` de confianza, el intervalo que estima el tiempo medio de reacción a un estímulo es (`r intervalo[1]`, `r intervalo[2]`) segundos. Si la confianza cambia al `r paste(x2, "%")`, el intervalo podría ser:
