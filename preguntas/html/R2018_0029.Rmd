...
correcta <- paste("Hay una confianza del ", confianza, "% que la media de horas dedicadas a usar redes sociales para toda la población esté entre (", intervalo[1], ", ", intervalo[2], ")", sep = "")
