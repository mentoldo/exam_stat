...
Question
========
**R2018_0015**. En un estudio determinado se quiso estudiar la relación entre el grado de satisfacción laboral y el tipo de organización. La siguiente tabla representa el `r caption[tipo]` Selecciones la afirmación correcta para la tabla siguiente:
